...
class ProfileScreenC extends StatefulWidget {
  const ProfileScreenC({super.key});

  @override
  State<ProfileScreenC> createState() => _ProfileScreenCState();
}
...
class _ProfileScreenCState extends State<ProfileScreenC> {
  ...
  DatabaseReference get userRef =>
      FirebaseDatabase.instance.ref('users/${Session.userKey}');
  ...
  Future<void> loadUserData() async {
    try {
      ...
      if (snapshot.exists) {
        ...
        userIdController.text = Session.userKey ?? '';
      ...
      showMessage('Failed to load cashier data: $e');
    } finally {
      if (mounted) {
  ...
  Future<void> saveUserData() async {
    ...
    try {
      ...
      showMessage('Cashier information updated successfully.');
    } catch (e) {
